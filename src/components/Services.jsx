...
//! icons
// import service5_icon from "@/assetss/icons/Movers&Packers.png";

// import service9_icon from "@/assetss/icons/Movers&Packers.png";

// import service13_icon from "@/assetss/icons/Movers&Packers.png";
...
//       onClick={() => service?.pdfUrl && onViewDetails(service)}
//       className={`group relative rounded-2xl border border-gray-100
//         pl-4 lg:pl-5 pt-4 lg:pt-4 pb-1
//         shadow-sm transition-all duration-300
//         hover:-translate-y-1 hover:shadow-md
//         ${sectionBg == "white" ? "bg-[#fbfbfb]" : "bg-white"}
//       `}
